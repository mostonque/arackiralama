    ...
    <div class="row ">
        ...
        <div class="col-7 ml-1  ">
            <div class="row">
                    ...
                    <a class="list-group-item col-md-2 d-inline-block list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Settings</a>
                    </div>
                <div class="col-12 mt-5">
                    ...
                    <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">deneme4</div>
                    </div>
                </div>
            </div>
